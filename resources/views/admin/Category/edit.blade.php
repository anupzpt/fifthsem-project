       ...
       <div class="table_section padding_infor_info">
        <form action="{{route('Category.update', [$category->categoryId])}}" method="post">
            ...
            <div class="form-group  p-2">
                ...
                <input type="text" class="form-control" id="exampleInputPassword1" placeholder="Enter Category"  name="name" value="{{$category->name}}">
              </div>
              <div class="form-group  p-2">
                <label for="exampleInputPassword1">Isparent</label>
                <label class="switch ml-3">
                    <input type="checkbox" name="isParent" value="{{$category->isParent}}" id="isParent" onclick="dropdown()" checked>
